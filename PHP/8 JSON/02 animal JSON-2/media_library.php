...
function renameFile(file) {
  var newName = prompt('Ingrese el nuevo nombre para el archivo:', file);
  if (newName !== null && newName !== '') {
    document.getElementById('newFilename_' + file).value = newName;
    document.getElementById('renameForm_' + file).submit();
  }
}
</script>
...
// Obtenemos una lista de todos los archivos en la carpeta excepto los mencionados en el array
...
<a class="btn" href="./upload.php"><i class="fa-regular fa-images"></i>Subir nueva imagen</a>
